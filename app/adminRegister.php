...
<form id="postRegData" class="d-flex align-items-center justify-content-center bg-br-primary ht-95v box">
    ...
    <div class="login-wrapper wd-300 wd-xs-400 pd-25 pd-xs-40 bg-white rounded shadow-base">
        <div class="signin-logo tx-center tx-28 tx-bold tx-inverse"> Course</div>
        <div class="tx-center mg-b-40">Registration Page</div>

        <div class="form-group">
            <input id ="department" required name="department" type="text" class="form-control" placeholder="Enter your Department">
